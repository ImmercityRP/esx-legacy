...
RegisterServerEvent('esx_licenseshop:buyLicenseFish')
AddEventHandler('esx_licenseshop:buyLicenseFish', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.Fish

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'fish', function()
			LoadLicenses(_source)
		end)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
...
RegisterServerEvent('esx_licenseshop:buyLicenseDiving')
AddEventHandler('esx_licenseshop:buyLicenseDiving', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.Diving

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'diving', function()
			LoadLicenses(_source)
		end)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
...
RegisterServerEvent('esx_licenseshop:buyLicenseElectrician')
AddEventHandler('esx_licenseshop:buyLicenseElectrician', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.Electrician

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'electrician', function()
			LoadLicenses(_source)
		end)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
...
RegisterServerEvent('esx_licenseshop:buyLicenseFood')
AddEventHandler('esx_licenseshop:buyLicenseFood', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.Food

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'food', function()
			LoadLicenses(_source)
		end)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
...
RegisterServerEvent('esx_licenseshop:buyLicenseHVAC')
AddEventHandler('esx_licenseshop:buyLicenseHVAC', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.HVAC

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'hvac', function()
			LoadLicenses(_source)
		end)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
...
RegisterServerEvent('esx_licenseshop:buyLicenseLumberjack')
AddEventHandler('esx_licenseshop:buyLicenseLumberjack', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.Lumberjack

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'lumberjack', function()
			LoadLicenses(_source)
		end)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
...
RegisterServerEvent('esx_licenseshop:buyLicenseMining')
AddEventHandler('esx_licenseshop:buyLicenseMining', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.Mining

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'mining', function()
			LoadLicenses(_source)
		end)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
