Locales['en'] = {
  ...
  ['citizen_wear'] = 'Off-Duty Wear',
  ['custom_outfit'] = 'Custom Uniform',
  ['police_wear'] = 'Standard Issue Uniform',
  ...
  ['service_not'] = 'You are not in uniform!',
  ['service_anonunce'] = 'service information',
  ['service_in'] = 'You\'ve dressed for service, good luck!',
  ['service_in_announce'] = 'operator ~y~%s~s~ has entered service!',
  ['service_out'] = 'Don\'t forget to go off-duty if you are staying in city!',
  ...
  ['hardcuff'] = 'Hard Cuff / Uncuff',
  ['search'] = 'Stop and Frisk',
  ['drag'] = 'Escort',
  ['put_in_vehicle'] = 'Seat in Vehicle',
  ['out_the_vehicle'] = 'Unseat from Vehicle',
  ['fine'] = 'Fine Citizen',
  ['unpaid_bills'] = 'View Unpaid Bills',
  ...
  ['no_players_nearby'] = 'There is nobody nearby!',
  ...
  ['phone_police'] = 'police',
  -- Surgery
  ['surgery_menu'] = 'Press ~INPUT_CONTEXT~ to change your Skin.',
  ['buy_surgery'] = 'Confirm your changes?',
  ['surgery_paid'] = 'Skin saved.',
  ['no'] = 'no',
  ['yes'] = 'yes',
  ['not_enough_money'] = 'You do not have enough money',
  --Jail
  ['jail_menu_info'] = 'Citizen Jail Time in Minutes',
  ['invalid_amount'] = 'Invalid Time Amount. Example: 5 = 5 Minutes',
  ['jail_menu'] = 'Choose Jail Location',
  ['mission_row'] = 'MRPD Cell Block',
  ['bolingbroke_pen'] = 'Bolingbroke Penitentiary',
  ['vinewood_prison'] = 'Vinewood Prison',
  ...
  ['mission_row_5'] = 'Mission Row Holding Cell',
  ['bolingbroke_pen_1'] = 'Bolingbroke Cell Block',
  ['bolingbroke_pen_2'] = 'Bolingbroke Pen. Cell Block 6',
  ['vinewood_prison_1'] = 'Vinewood Prison Yard',
}
